...
# Constants
DEFAULT_LIVE_TRACKER = "oscillation_experimental"
    ...
    def initialize(self, app_instance, **kwargs) -> bool:
        ...
        try:
            ...
            if hasattr(app_instance, 'app_settings'):
                ...
                self.live_tracker_name = settings.get('stage3_live_tracker', 'oscillation_experimental')
            ...
            try:
                ...
                if not self.tracker_manager.set_tracking_mode(self.live_tracker_name):
                    ...
                    fallback_trackers = ['oscillation_experimental']
                    tracker_set = False
