...
class HapticAIUninstaller:
    ...
    def print_header(self):
        ...
        print("    HapticAI (Beta) Universal Uninstaller")
    ...
    def print_completion_message(self):
        ...
        print(f"\n{Colors.GREEN}HapticAI (Beta) has been successfully uninstalled.{Colors.ENDC}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="HapticAI (Beta) Universal Uninstaller",
...
Examples:
  ...
  python hapticai_uninstall.py --dry-run          # Preview only
    ...
    parser.add_argument(
        "--version",
        action="version",
        version="HapticAI (Beta) Uninstaller 1.0.0"
    )
