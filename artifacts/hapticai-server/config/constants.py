...
MODEL_DOWNLOAD_URLS = {
    "detection_pt": "https://github.com/ack00gar/HapticAI-AI-Powered-Funscript-Generator/releases/download/models-v1.1.0/HapticAI-12s-pov-1.1.0.pt",
    "detection_mlpackage_zip": "https://github.com/ack00gar/HapticAI-AI-Powered-Funscript-Generator/releases/download/models-v1.1.0/HapticAI-12s-pov-1.1.0.mlpackage.zip",
    "pose_pt": "https://github.com/ultralytics/assets/releases/download/v8.3.0/yolo11n-pose.pt"
}

# Splash screen emoji URLs (CDN downloads disabled - using local neutral placeholders)
SPLASH_EMOJI_URLS = {}

# UI control icon URLs (CDN downloads disabled - using local neutral placeholders)
# Icons are served from assets/ui/icons/ subdirectory
