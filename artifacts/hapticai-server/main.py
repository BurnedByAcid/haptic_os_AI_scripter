    ...
    try:
        ...
        try:
            ...
            if branch_result.returncode == 0 and branch_result.stdout.strip():
                ...
                if os.environ.get('HAPTICAI_DEBUG_GIT'):
...
def run_cli(args):
    ...
    logger.info("--- HapticAI (Beta) CLI Mode ---")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="HapticAI (Beta) - Automatic Funscript Generation and Processing")
